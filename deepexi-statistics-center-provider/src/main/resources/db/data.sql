...
CREATE TABLE IF NOT EXISTS user(
    id int  not null primary key,    created_by varchar(255) not null ,    created_at datetime not null ,    updated_by varchar(255) not null ,    updated_at datetime not null ,    name varchar(255) not null );
